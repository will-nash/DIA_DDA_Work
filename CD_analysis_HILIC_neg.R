...
cd_results_analysis <- function(folder, file, ion_mode, assay){
  
  
  #Imports CD results
  cd_res <- read.csv(paste0("Z:/users/wxn264/DIA_DDA_Nov_2017/Compound_Discoverer/", assay, "_", ion_mode, "/", folder, "/", assay, "_Plasma_", ion_mode, "_DDA_70K_", file, ".csv"))
...
cd_results_analysis("Tra", "Tra_1", "NEG", "HILIC")
cd_results_analysis("Tra_exc", "Tra_exc_1", "NEG", "HILIC")
cd_results_analysis("Tra_inc", "Tra_inc_1", "NEG", "HILIC")
cd_results_analysis("Tra_p_exc_1", "Tra_p_exc_1_1", "NEG", "HILIC")
cd_results_analysis("Tra_p_exc_2", "Tra_p_exc_1_2", "NEG", "HILIC")
cd_results_analysis("Mull1", "Mull1_1", "NEG", "HILIC")
cd_results_analysis("Mull1_1", "Mull1_exc_1_1", "NEG", "HILIC")
cd_results_analysis("Mull1_2", "Mull1_exc_1_2", "NEG", "HILIC")
cd_results_analysis("Mull2", "Mull2_1", "NEG", "HILIC")
cd_results_analysis("Mull2_1", "Mull2_exc_1_1", "NEG", "HILIC")
cd_results_analysis("Mull2_2", "Mull2_exc_1_2", "NEG", "HILIC")
cd_results_analysis("Mull3", "Mull3_1", "NEG", "HILIC")
cd_results_analysis("Mull3_1", "Mull3_exc_1_1", "NEG", "HILIC")
cd_results_analysis("Mull3_2", "Mull3_exc_1_2", "NEG", "HILIC")
